...
export class CharacterFlyFSM extends FiniteStateMachine {
    constructor(target) {
        super(target);
        ...
        this._targetDict = {
            ...
            Body: { name: "AllRoot_01", mesh: null, initValue: new THREE.Vector3(PI_2, 0, 0) },
            Head: { name: "Head_014", mesh: null, initValue: new THREE.Vector3(0, 0, 0.24) },
            Cap: {name: "Cap_015", mesh: null},

            Shoulder_sx: { name: "ShoulderL_016", mesh: null, initValue: new THREE.Vector3(-PI_2, 0, -PI_4) },
            Upper_arm_sx: { name: "ArmL1_017", mesh: null, initValue: new THREE.Vector3(0, 0, -PI_4) },
            Elbow_sx: { name: "ArmL2_018", mesh: null },

            Shoulder_dx: { name: "ShoulderR_020", mesh: null, initValue: new THREE.Vector3(PI_2, 0, -PI_4) },
...
class IdleState extends State {
    ...
    update(input) {
        ...
        switch (this._stateHead) {
            case 0:
                if (this._targetDict.Head.mesh.rotation.z >= 0.36) {
                    this._stateHead = 1;
                } else {
            ...
            case 1:
                if (this._targetDict.Head.mesh.rotation.z <= 0.24) {
                    this._stateHead = 0;
                } else {
                    this._targetDict.Head.mesh.rotation.z -= speed;
                }
        ...
        switch (this._stateArms) {
            case 0:
                if (this._targetDict.Upper_arm_dx.mesh.rotation.y >= 0.4) {
                    this._stateArms = 1;
                } else {
        ...
        switch (this._stateLegs) {
            case 0:
                if (this._targetDict.Upper_leg_sx.mesh.rotation.z >= 0.1) {
                    this._stateLegs = 1;
                } else {
                    ...
                    if (this._targetDict.Lower_leg_dx.mesh.rotation.z >= -0.1) {
            ...
            case 1:
                if (this._targetDict.Upper_leg_sx.mesh.rotation.z <= -0.1) {
                    ...
                    this._targetDict.Upper_leg_sx.mesh.rotation.z -= speed;
                    if (this._targetDict.Lower_leg_sx.mesh.rotation.z >= -0.1) {
                        this._targetDict.Lower_leg_sx.mesh.rotation.z -= speed;
                    }
